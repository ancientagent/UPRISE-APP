...
Node.js Web application for backend API integration
...
```
cd existing_repo
git remote add origin https://gitlab.com/imaginnovate_ps/upriseradiyo/webapp_api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:24d6a805428ccd172daf3e8cf8e416ee?https://gitlab.com/imaginnovate_ps/upriseradiyo/webapp_api/-/settings/integrations)
...
- move sequelize config values to env file
- config swagger
- setup JWT Acess Token & Refresh Token.
