...
const AlbumSongs = ({navigation, route}) => {
  ...
  const showLoading = useSelector(
    state => state.songList.isWaiting || state.albumDetails.isWaiting,
  );
        ...
        <View style={styles.contentView}>
          <View style={{height: '85%'}}>
            <ImageBackground
              ...
              source={
                albumDetails.thumbnail
                  ? {uri: albumDetails.thumbnail}
                  : require('../../../../assets/images/Fullprev_album_img.png')
              }>
            ...
            <View>
              ...
              <View style={{height: '60%'}}>{renderSongsList(songData)}</View>
            </View>
          </View>
