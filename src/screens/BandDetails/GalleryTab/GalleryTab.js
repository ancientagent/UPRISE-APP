...
import {getBandGallery} from '../../../state/selectors/UserProfile';
    ...
    <View style={styles.galleryTabView}>
        ...
        <FlatGrid
          ...
          renderItem={({item, index}) => (
            <TouchableOpacity
              ...
              <Image style={styles.gridImage} source={{uri: item.mediaURL}} />
      ...
      {BandGallery.length > 8 && (
        <Text
          ...
          onPress={() => navigation.navigate('FullGalleryView')}>
