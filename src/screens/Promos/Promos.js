...
import {getHomePromos} from '../../state/selectors/UserProfile';
import {homePromosSagaAction} from '../../state/actions/sagas';
...
const Promos = () => {
  ...
  console.log(
    '--- PROMOS COMPONENT: PromosData length ---',
    PromosData?.length || 0,
  );
  console.log('--- PROMOS COMPONENT: PromosData type ---', typeof PromosData);
  console.log(
    '--- PROMOS COMPONENT: PromosData is array ---',
  ...
  console.log(
    '--- PROMOS COMPONENT: formatedSongList length ---',
    formatedSongList?.length || 0,
  );
  ...
  console.log(
    '--- PROMOS COMPONENT: Redux state isWaiting ---',
    fullReduxState?.isWaiting,
  );
  console.log(
    '--- PROMOS COMPONENT: Redux state error ---',
    fullReduxState?.error,
  );
  console.log(
    '--- PROMOS COMPONENT: Redux state data ---',
    fullReduxState?.data
  );

    useEffect(() => {
    console.log(
      '--- PROMOS COMPONENT: useEffect triggered - dispatching homePromosSagaAction ---',
    );
    console.log(
      '--- PROMOS COMPONENT: About to dispatch homePromosSagaAction ---',
    );
  ...
  console.log(
    '--- PROMOS COMPONENT: PromosData.length === 0 ---',
    PromosData.length === 0,
  );
  console.log('--- PROMOS COMPONENT: !showLoading ---', !showLoading);
  console.log(
    '--- PROMOS COMPONENT: Will show empty component ---',
    PromosData.length === 0 && !showLoading,
  );
  console.log('--- PROMOS COMPONENT: Will show loading ---', showLoading);
  console.log(
    '--- PROMOS COMPONENT: Will show FlatList ---',
    PromosData.length > 0 && !showLoading,
  );
                  ...
                  <View style={styles.eventView}>
                    ...
                    <View style={{marginHorizontal: 10}}>
                      ...
                      <Text style={styles.bandSubText}>
                        <Text style={styles.bandText}>Description:</Text>{' '}
                        {item.description}
                      </Text>
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          if (
                            _.startsWith(item.link, 'https://' || 'http://')
                          ) {
