...
import {getMostRatedSongsList} from '../../../state/selectors/UserProfile';
  ...
  return (
    <URHeaderContainer>
      ...
      <View style={styles.AllAlbumsView}>
        <View style={[styles.AllAlbumsContainer, {marginHorizontal: 20}]}>
          <FlatList
                ...
                <View style={styles.ratedImageView}>
                  <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={styles.ratedTextView}>
                      <Text style={styles.ratedTextStyle}>{item.title}</Text>
                      <Text style={styles.ratedTitle}>{item.band.title}</Text>
