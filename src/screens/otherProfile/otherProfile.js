...
const OtherProfile = ({route, navigation}) => {
  ...
  const showLoading = useSelector(
    state =>
      state.getUserDetails.isWaiting ||
      state.followingBands.isWaiting ||
      state.otherUserProfile.isWaiting,
  );
            ...
            <View style={styles.membersImageView}>
              <Image
                ...
                source={
                  item.logo
                    ? {uri: item.logo}
                    : require('../../../assets/images/band_img.png')
                }
              />
              ...
              <Image
                source={
                  OtherUserData.avatar
                    ? {uri: OtherUserData.avatar}
                    : require('../../../assets/images/users.png')
                }
                style={styles.profileImage}
              />
              <Text style={styles.profileName}>{OtherUserData.userName}</Text>
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.promosView}>
                    <Image
                      ...
                      source={
                        OtherUserData.band && OtherUserData.band.logo
                          ? {uri: OtherUserData.band.logo}
                  ...
                  <View style={styles.bandListView}>
                    ...
                    {bandList.length > 10 && (
                      <Text
                        ...
                        onPress={() => navigation.navigate('AllBandList')}>
