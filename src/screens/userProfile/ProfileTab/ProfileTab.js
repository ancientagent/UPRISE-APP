...
import {
  ...
  getUserAvatarSagaAction,
  getInstrumentSagaAction,
...
const ProfileTab = props => {
  ...
  const handleformSubmit = values => {
    ...
    if (userDetails.roleName !== 'ARTIST') {
      {
        values.faceBookID === null || ''
          ? formData.append('facebook', null)
          : formData.append('facebook', values.faceBookID);
      }
      {
        values.instaID === null || ''
          ? formData.append('instagram', null)
          : formData.append('instagram', values.instaID);
      }
      {
        values.tweetID === null || ''
          ? formData.append('twitter', null)
          : formData.append('twitter', values.tweetID);
      }
    }
        ...
        {!EditMode ? (
          <View>
            ...
            <View style={{marginTop: 20}}>
              <View style={styles.mailIconView}>
                ...
                />
                <Text style={{color: Colors.sideHeadingText}}>
                  {userDetails.email}
                </Text>
              </View>
          ...
          <Formik
            initialValues={{
              ...
              faceBookID:
                userDetails.facebook === null ? '' : userDetails.facebook,
              instaID:
                userDetails.instagram === null ? '' : userDetails.instagram,
