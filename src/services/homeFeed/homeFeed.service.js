...
export default function homeFeedRequest(payload) {
  ...
  console.log(
    '--- HOME FEED SERVICE: payload.accessToken ---',
  ...
  console.log(
    '--- HOME FEED SERVICE: Full URL ---',
    getRequestURL(Config.HOME_FEED),
  );
  ...
  return request(requestOptions)
    .then(response => {
      ...
      console.log(
        '--- HOME FEED SERVICE: Response status ---',
        response?.status,
      );
      console.log('--- HOME FEED SERVICE: Response data ---', response?.data);
      console.log(
        '--- HOME FEED SERVICE: Response data length ---',
    ...
    .catch(error => {
      ...
      console.log(
        '--- HOME FEED SERVICE: Error status ---',
