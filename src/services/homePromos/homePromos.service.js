...
export default function homePromosRequest(payload) {
  ...
  console.log(
    '--- HOME PROMOS SERVICE: Config.HOME_PROMOS ---',
    Config.HOME_PROMOS,
  );
  console.log('--- HOME PROMOS SERVICE: payload.state ---', payload.state);
  console.log(
    '--- HOME PROMOS SERVICE: payload.accessToken ---',
  ...
  return request(requestOptions)
    .then(response => {
      console.log(
        '--- HOME PROMOS SERVICE: API response received ---',
        response,
      );
      console.log(
        '--- HOME PROMOS SERVICE: Response status ---',
        response?.status,
      );
      console.log('--- HOME PROMOS SERVICE: Response data ---', response?.data);
      console.log(
        '--- HOME PROMOS SERVICE: Response data length ---',
    ...
    .catch(error => {
      ...
      console.log(
        '--- HOME PROMOS SERVICE: Error response ---',
        error?.response,
      );
      console.log(
        '--- HOME PROMOS SERVICE: Error status ---',
