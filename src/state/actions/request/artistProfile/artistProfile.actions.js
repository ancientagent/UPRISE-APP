...
export const artistProfileType = createRequestResponseActionTypeSet(
  `${ActionNamespace}/GET_ARTIST_PROFILE`,
);
export const updateArtistProfileType = createRequestResponseActionTypeSet(
  `${ActionNamespace}/UPDATE_ARTIST_PROFILE`,
);
