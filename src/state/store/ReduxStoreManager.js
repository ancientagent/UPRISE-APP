...
export default class ReduxStoreManager {
  constructor() {
    ...
    console.log(
      '--- REDUX STORE: Persist configuration created successfully ---',
    );
    ...
    console.log(
      '--- REDUX STORE: Store with middleware created successfully ---',
    );

    console.log('--- REDUX STORE: Creating persisted root reducer ---');
    const persistedRootReducer = persistReducer(persistConfig, rootReducer);
    console.log(
      '--- REDUX STORE: Persisted root reducer created successfully ---',
    );
