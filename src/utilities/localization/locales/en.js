export default {
  ...
  userLocation: {
    ...
    subTitle: "Let's setup your home scene",
    welcomeToUprise: 'Welcome to Uprise!',
    primaryGenre: 'Which genre are you most affiliated with?',
    searchGenre: 'Search for a genre...',
  ...
  OnDemandMusic: {
    selectPickText: 'Please make a selection from the list to proceed.',
  },
  Signup: {
    signupText: 'SIGN UP',
  ...
  SignupValidators: {
    ...
    confirmPasswordValid: 'Both passwords need to be the same',
    bothPassword: 'Both passwords need to be the same',
  },
